...
namespace GameCaro
{
    public class ChessBoardManager
    {
        ...
        public ChessBoardManager(Panel chessBoard, TextBox playerName, PictureBox mark)
        {
            ...
            {
                new Player("NguoiChoi1",Image.FromFile(Application.StartupPath + "\\Resources\\quan.jpg") ),
                new Player("NguoiChoi2", Image.FromFile(Application.StartupPath + "\\Resources\\quan2.jpg"))
            };
